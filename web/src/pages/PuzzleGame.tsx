...
import { ArrowLeft, Lock, RotateCcw, Target } from 'lucide-react';
...
const PuzzleGame = () => {
    ...
    const finishPuzzle = (
        ...
        // Only checked on success inside the engine as well,
        // but we pass attempts so "grind" achievements can work.
    ...
    const handleScoreSelect = (category: string, value: number) => {
        ...
        if (allComplete) {
            ...
            // Next turns are always "normal Yahtzee" (no preset).
            setTurnIndex((t) => t + 1);
            setupTurn(false);
        }
    };
